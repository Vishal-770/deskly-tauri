  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 font-saira select-none">
      <div className="text-center max-w-sm mx-auto space-y-6 animate-fade-in">
        <div className="w-16 h-16 rounded-xl bg-sky-500/10 border border-sky-500/25 flex items-center justify-center mx-auto">
        ...
        {onRetry && (
          <Button
            onClick={onRetry}
            variant="outline"
            className="w-full max-w-[200px] h-10 rounded-md text-xs font-semibold border-border/10 bg-muted/20 hover:bg-muted/30 transition-all gap-2"
          >
