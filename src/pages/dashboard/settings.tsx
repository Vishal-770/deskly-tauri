...
export default function SettingsPage() {
  ...
  return shell(
    <div className="w-full max-w-7xl mx-auto space-y-8 px-2 sm:px-4">
      {/* Header */}
      <header className="pb-6 border-b border-border/20 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="space-y-4">
              {/* Theme Settings Card */}
              <div className="bg-gradient-to-br from-card/40 to-card/10 hover:from-card/50 hover:to-card/20 border border-border/20 rounded-3xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.01)] backdrop-blur-sm transition-all duration-300 flex items-center justify-between">
              ...
              <div className="bg-gradient-to-br from-card/40 to-card/10 hover:from-card/50 hover:to-card/20 border border-border/20 rounded-3xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.01)] backdrop-blur-sm transition-all duration-300 flex items-center justify-between">
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-foreground">Hostel Block</h3>
                    <p className="text-[10px] sm:text-xs text-muted-foreground mt-0.5">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-card/40 to-card/10 hover:from-card/50 hover:to-card/20 border border-border/20 rounded-3xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.01)] backdrop-blur-sm transition-all duration-300 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3.5">
                    <ArrowUpCircle className="w-5 h-5 text-primary shrink-0" />
                    <div>
                      <h3 className="text-sm font-bold text-foreground">Software Update</h3>
                      <p className="text-[10px] sm:text-xs text-muted-foreground mt-0.5">
                  ...
                  {updateStatus === "upToDate" && (
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-bold text-foreground bg-primary/10 border border-primary/20 px-2.5 py-1 rounded-full flex items-center gap-1">
                  ...
                  {updateStatus === "error" && (
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-bold text-destructive bg-destructive/10 border border-destructive/20 px-2.5 py-1 rounded-full flex items-center gap-1">
                  ...
                  <div className="pt-4 border-t border-border/10 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 transition-all text-xs font-bold rounded-xl cursor-pointer shadow-sm animate-pulse"
                      >
                        Install Update
                      </button>
                    </div>
                    {activeUpdate.body && (
                      <div className="p-4 bg-muted/20 border border-border/10 rounded-2xl text-[11px] text-muted-foreground max-h-32 overflow-y-auto no-scrollbar font-medium">
                        <p className="font-bold text-foreground/85 mb-1.5">Release Notes:</p>
                ...
                {updateStatus === "downloading" && downloadProgress && (
                  <div className="pt-4 border-t border-border/10 space-y-3">
                    ...
                    {/* Progress Bar */}
                    <div className="w-full h-2 bg-muted/30 border border-border/10 rounded-full overflow-hidden">
                      <div 
                ...
                {updateStatus === "finished" && (
                  <div className="pt-4 border-t border-border/10 flex items-center gap-3 text-xs font-bold text-primary">
                ...
                {updateStatus === "error" && updateError && (
                  <p className="text-[10px] text-destructive bg-destructive/5 border border-destructive/10 p-3 rounded-2xl font-bold uppercase tracking-wider">
                    {updateError}
                  </p>
                )}
              </div>
              ...
              <div className="bg-gradient-to-br from-card/40 to-card/10 hover:from-card/50 hover:to-card/20 border border-border/20 rounded-3xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.01)] backdrop-blur-sm transition-all duration-300 flex items-center justify-between">
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-foreground">Legal & Privacy Policy</h3>
                    <p className="text-[10px] sm:text-xs text-muted-foreground mt-0.5">
                ...
                <Link
                  to="/legal"
                  className="px-4 py-2 bg-muted hover:bg-muted/80 text-foreground transition-all text-xs font-bold rounded-xl cursor-pointer shadow-sm flex items-center justify-center border border-border/10"
                >
                  View Policy
                </Link>
              </div>
              ...
              <div className="bg-destructive/5 border border-destructive/20 rounded-3xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.01)] backdrop-blur-sm transition-all duration-300 flex items-center justify-between">
                <div className="flex items-center gap-3.5">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-destructive text-destructive-foreground hover:bg-destructive/95 transition-all text-xs font-bold rounded-xl cursor-pointer shadow-sm"
                >
                  Sign Out
                </button>
              </div>
