...
use crate::auth::helpers::{get_default_semester_id, response_text_with_auth_retry, selected_semester_id_from_store};
...
use crate::timetable::types::WeeklyScheduleResponse;
